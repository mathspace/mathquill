...
LatexCmds.pi = LatexCmds['π'] = bind(VanillaSymbol,'\\pi ','&pi;');
LatexCmds.lambda = bind(VanillaSymbol,'\\lambda ','&lambda;');
...
LatexCmds.Upsih = //'cos it makes sense to me
  bind(VanillaSymbol,'\\Upsilon ','&upsih;');
